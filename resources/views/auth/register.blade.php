                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center pl-0 pr-3 py-0">
                                    <img src="{{asset('public/theme/app-assets/images/logo/pamojapay-logo.png')}}" alt="branding logo" class="pamojapay-logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2 bg-success text-white">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-0">
                                                <form action="{{route('register.post')}}" method="post">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputPhoneNo" class="form-control" placeholder="Phone number" required name="phone">
                                                        ...
                                                        <div class="col-12">
                                                            <fieldset class="checkbox">
                                                                <div class="vs-checkbox-con vs-checkbox-dark">
                                                                    ...
                                                                    <span class="text-white"> I accept the <a href="#" class="text-dark">Terms & conditions</a></span>
                                                                </div>
                                                            </fieldset>
                                                        </div>
                                                    </div>
                                                    <button type="submit" class="btn btn-dark btn-block mb-50">SIGN UP s</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>

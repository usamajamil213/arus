        ...
        <div class="row">
            ...
            <div class="col s12 m12 l12">
                ...
                <div id="bordered-table">
                    ...
                    <a href="{{url('admin/add/custom/sms',['url'=>$url])}}" class="btn btn-primary">Add SMS</a>
                    <div class="row">
                        <div class="col s12 m12 l12">
                            ...
                            <div class="row">
                                <div class="col s12">
                                    <ul class="tabs tab-demo z-depth-1">
                                        ...
                                        <li class="tab"><a class="active" href="#test<?=$tab;?>">
                                            ...
                                            <tbody>
                                                    ...
                                                    { //print_r($item_value);die();?>
                                                        ...
                                                        <tr>
                                                            <td>#</td>
                                                            <td>{{$val->message}}</td>
                                                            <td>@if($val->active==1) {{'Yes'}} @else {{'No'}} @endif</td>
...
<td>
                                                    <div class="container">
                                                        ...
                                                        <ul id="dropdown<?=$name.$s_no;?>" class="drop dropdown-content" style="white-space: nowrap; opacity: 1;width: 140px; top: 130px; display: none;">
                                                            <li><a class="grey-text text-darken-2" href="{{ URL::Route('admin/edit/sms/custom',[$val->id]) }}">{{ trans('localization::lang_view.edit')}}</a></li>

                                                            <?php if ($val->active == 0) { ?>
                                                            <li><a onclick="" class="sweet-active grey-text text-darken-2" href="{{ URL::Route('admin/sms/custom/active',[$val->id]) }}">{{ trans('localization::lang_view.active')}}</a></li>
                                                            <?php } else { ?>
                                                            <li><a class="sweet-inactive grey-text text-darken-2" href="{{ URL::Route('admin/sms/custom/inactive',[$val->id]) }}">{{ trans('localization::lang_view.inactive')}} </a></li>
